...
with open('blastn_taxonomy_modified.csv', mode='w', newline='') as keys_file:
    ...
    # Add column names
    value = ['query_id','subject_id','%identity','alignment_length','mismatches','gap_open','q_start','q_end','s_start','s_end','evalue','bit_score','prokaryote/virus/eukaryote','database_identifier','taxonomy','TRUE/FALSE','ref_seq_no']
